<?php
    ...
    class TarificationPostController extends AbstractController implements IController {
        ...
        function processRequest() {
            $this->newtarif = Tarification::create($this->source, $this->destination, $this->tarif, $this->distance);

            try{
                $this->newtarif = $this->service->insertData($this->newtarif);
        ...
        function processResponse() {
            echo json_encode($this->newtarif);
        }
    }
?>